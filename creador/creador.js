/* ═══════════════════════════════════════════════════════════════
   Creador de Personaje — Mistborn D20 (Sombras sobre Fellise)
   ═══════════════════════════════════════════════════════════════ */
...
const ABILITY_DETAILS = {
  ...
  "Enfoque Sensorial":{costo:"2 RM",tirada:"CON save DC 12 al final si se fuerza",alcance:"Escena corta",efecto:"Ignorás penalidades de niebla/ruido/oscuridad parcial y no sufrís desventaja por visión reducida común.",notas:"Brilla en Fellise y fundición."},
  ...
  "Contactos de Fellise":{costo:"Sin RM",tirada:"Persuasión/Investigación/Carisma",alcance:"Ciudad y downtime",efecto:"Tenés una red de favores. 1 vez por sesión podrías obtener un dato, refugio o presentación creíble a costo razonable.",notas:"Poder social/logístico consistente."},
  ...
  "Instinto de Superviviente":{costo:"Pasivo + reacción",tirada:"DES o SAB save mejorado",alcance:"Emboscadas y retiradas",efecto:"Ventaja en checks para escapar, resistir pánico de calle y reaccionar a traiciones/emboscadas.",notas:"Muy temático para Fellise."},
...
function renderStep0(){
  $container.innerHTML = `
    ...
    <div class="form-group">
      ...
      <textarea id="f-bg" placeholder="¿De dónde viene? ¿Qué busca en Fellise?">${esc(state.background)}</textarea>
    </div>
  `;
}
function saveStep0(){
