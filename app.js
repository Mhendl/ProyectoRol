...
const CLASS_PROGRESSION = [
  {
    ...
    levels: [
      ...
      { n:2,  bm:2, rm:4, hp:28, gains:["Impacto Pesado (+1d4 daño 1 vez por turno)","Presencia Aplastante (Intimidación + control social)"], note:"Sube daño sin romper balance. Herramienta social." },
      ...
      { n:5,  bm:3, rm:6, hp:46, gains:["Ataque Extra","Carga de Peltre (cierre de distancia + daño)"], note:"Gran salto de poder y movilidad." },
      { n:6,  bm:3, rm:6, hp:52, gains:["Habilidad de subclase (N6)","Piel de Peltre (PG temporales al encender)"], note:"Consolida rol + buffer defensivo." },
      ...
      { n:9,  bm:4, rm:8, hp:70, gains:["Fulgor de Peltre (técnica icónica)","Rugido del Bruto (AoE miedo/control)","Habilidad de subclase (N9)"], note:"Power spike fuerte + control de área." },
  ...
  },
  {
    ...
    levels: [
      ...
      { n:2,  bm:2, rm:4, hp:24, gains:["Apuntar (+2 ataque o +1d4 daño si no se movió)","Escudo de Monedas (reacción: +2 CA)"], note:"Posicionamiento + primera defensa." },
      ...
      { n:5,  bm:3, rm:6, hp:39, gains:["Disparo Doble / Ataque Extra a distancia","Líneas de Acero (detección de metal pasiva)"], note:"Gran salto de daño + utilidad." },
      { n:6,  bm:3, rm:6, hp:44, gains:["Habilidad de subclase (N6)"], note:"Cadena de tiros o zona de control según build." },
      { n:7,  bm:3, rm:7, hp:49, gains:["Cobertura Inteligente (+defensa si reposiciona bien)","Rebote Letal (ignora cobertura total)"], note:"Defensa + ataque de ángulo muerto." },
      { n:8,  bm:3, rm:7, hp:54, gains:["+2 atributos o 1 talento"], note:"Segunda optimización del build." },
      { n:9,  bm:4, rm:8, hp:59, gains:["Lluvia de Acero (técnica icónica de área/línea)","Ancla de Escape (reacción: vuelo defensivo)","Habilidad de subclase (N9)"], note:"Amenaza de campo + escape." },
  ...
  },
  {
    ...
    levels: [
      ...
      { n:2,  bm:2, rm:4, hp:23, gains:["Agarre a Distancia (+manipulación táctica mejorada)","Dedos Magnéticos (robo sutil de metal)"], note:"Manipulación + herramienta social." },
      ...
      { n:5,  bm:3, rm:6, hp:38, gains:["Tirón Potente (mover objetos pesados / jalar enemigos)","Fragmentos Orbitantes (+1 CA + daño a melee)"], note:"Control + defensa orbital." },
      { n:6,  bm:3, rm:6, hp:43, gains:["Habilidad de subclase (N6)"], note:"Desarme avanzado o manipulación de terreno." },
      { n:7,  bm:3, rm:7, hp:48, gains:["Tirón Defensivo (reacción: cubrir aliados con metal)","Red de Hierro (AoE trampa metálica)"], note:"Defensa reactiva + control de área." },
      { n:8,  bm:3, rm:7, hp:53, gains:["+2 atributos o 1 talento"], note:"Segunda optimización del build." },
      { n:9,  bm:4, rm:8, hp:58, gains:["Vórtice de Hierro (zona de control con chatarra)","Imán Humano (vuelo magnético 9m)","Habilidad de subclase (N9)"], note:"Control + movilidad Mistborn." },
  ...
  },
  {
    ...
    levels: [
      ...
      { n:2,  bm:2, rm:4, hp:23, gains:["Aprovechar Hueco (+daño situacional 1/turno)","Golpe Certero (1d6+DES, potenciado vs desprevenidos)"], note:"Primer ataque real del Acechador." },
      ...
      { n:5,  bm:3, rm:6, hp:38, gains:["Precisión Mejorada (daño extra escala)","Leer Intenciones (detector de mentiras sensorial)"], note:"Spike de daño + herramienta social." },
  ...
  },
  {
    ...
    levels: [
      ...
      { n:5,  bm:3, rm:6, hp:32, gains:["Control en Área (cono/área pequeña)","Pánico Inducido (huida forzada + OA aliados)"], note:"Pico de utilidad + movimiento forzado." },
      { n:6,  bm:3, rm:6, hp:36, gains:["Habilidad de subclase (N6)","Máscara Emocional (inmune a lecturas + ventaja vs miedo)"], note:"Subclase + autodefensa emocional." },
      { n:7,  bm:3, rm:7, hp:40, gains:["Rebote Emocional (reacción defensiva/debuff)","Susurro Venenoso (voltea enemigo contra sus aliados)"], note:"Supervivencia + infiltración en combate." },
      { n:8,  bm:3, rm:7, hp:44, gains:["+2 atributos o 1 talento"], note:"Segunda vuelta de build/control." },
      { n:9,  bm:4, rm:8, hp:48, gains:["Tormenta Emocional (técnica icónica)","Dueño del Momento (AoE aturdir emocional)","Habilidad de subclase (N9)"], note:"Puede cambiar combates enteros." },
  ...
  },
  {
    ...
    levels: [
      ...
      { n:2,  bm:2, rm:4, hp:23, gains:["Lectura de Patrón (+detección/trampas/rastros)","Análisis Letal (+1d6 daño a objetivo analizado)","Pulso Disruptivo (reacción: daño + cancelar alomancia)"], note:"Detección + primeros ataques del Buscador/Velador." },
      ...
      { n:5,  bm:3, rm:6, hp:38, gains:["Contramedida (reacción para reducir técnica enemiga)","Interrogador de Pulsos (detector de mentiras metálico)","Aura de Confianza (ventaja Persuasión en Nube)"], note:"Anti-técnicas + herramientas sociales." },
      { n:6,  bm:3, rm:6, hp:43, gains:["Habilidad de subclase (N6)"], note:"Mejora detección/rastreo o protección de grupo." },
      { n:7,  bm:3, rm:7, hp:48, gains:["Interferencia (reacción avanzada anti-técnica)","Resonancia Agresiva (2d6 psíquico a alomante)","Silencio Aplastante (drena RM enemiga)"], note:"Control + ataques anti-alomancia." },
      { n:8,  bm:3, rm:7, hp:53, gains:["+2 atributos o 1 talento"], note:"Consolida el rol de especialista." },
      { n:9,  bm:4, rm:8, hp:58, gains:["Mapa Invisible (técnica icónica)","Ojo que Todo lo Ve (radar constante + info total)","Vacío de Cobre (zona sin alomancia 1 ronda)","Habilidad de subclase (N9)"], note:"Radar + shutdown nuclear + ventaja táctica total." },
  ...
  },
  {
    ...
    levels: [
      ...
      { n:7,  bm:3, rm:0, hp:48, gains:["Instinto de Superviviente (reacción mejorada)","Veterano de las Cenizas (+1d4 improvisadas, Help bonus, furia)"], note:"Supervivencia + combate callejero veterano." },
